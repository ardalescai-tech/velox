      ...
      <div className="ai-section">
        ...
        <div className="ai-quick-questions">
          ...
          <div className="ai-questions-grid">
            <button className="ai-question-btn" onClick={() => askAI('Ce ar trebui să mănânc la următoarea masă?')}>Ce să mănânc acum?</button>
            <button className="ai-question-btn" onClick={() => askAI('Cum mă descurc cu caloriile azi? Sunt pe drumul cel bun?')}>Sunt pe drumul bun?</button>
            <button className="ai-question-btn" onClick={() => askAI('Dă-mi un sfat pentru obiectivul meu de azi.')}>Sfat pentru azi</button>
          </div>
        </div>
